...
class BookController extends Controller
{
     ...
     */
// Fitur list book per halaman 10 item dengan paginate
    public function index(Request $request)
        ...
        if($status){
        // memberikan query param / query string di url
        // memberikan filter
        $books = \App\Models\Book::with('categories')->where('title',
        "LIKE", "%$keyword%")->where('status', strtoupper($status))->paginate(10);
        } else {
 ...
 return view('books.index', ['books' => $books]);
     ...
     * @return \Illuminate\Http\Response
     */
// Menampilkan views/books/create.blade.php
...
// Menangkap request create user di controller action 
    public function store(Request $request)
    {
        ...
        // menangkap request create book dan menyimpannya ke dalam model Book baru yang belum ada di database
        ...
        // Ingat bahwa nilainya hanya dua yaitu PUBLISH atau DRAFT
        ...
        // isi field created_by dengan ID dari user yang sedang login dan mensubmit data 
        ...
        // simpan data model tersebut ke database
        $new_book->save();
...
// Fitur edit book
    public function update(Request $request, $id)
    {
        ...
        \Validator::make($request->all(), [
            ...
            "slug" => [
            "required",
        // Illuminate\Validation\Rule untuk mengecek unique dengan mengabaikan data slug dari book yang sedang diedit
    ...
    // Fitur Restore mengembalikan buku-buku yang berstatus soft deleted / trashed
    ...
    public function deletePermanent($id){
       ...
       in trash!')->with('status_type', 'alert');
        ...
        // Sebelum menggunakan forceDelete(); gunakan $book->categories()->detach(); 
        // karena ingin menghapus relationship buku yang akan dihapus dengan Category jika ada. jika tidak akan terjadi eror
