...
{{-- Fitur pencarian order      mencari order berdasarkan email pembeli (buyer email) dan berdasarkan status order--}}
  ...
  <table class="table table-stripped table-bordered">
   ...
   <tbody>
    ...
    <tr>
     ...
     {{-- kode {{$order->totalQuantity}} harus di definisikan dulu di Models/Order.php dan tambahkan dynamic property--}}
